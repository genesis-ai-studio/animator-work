...
echo "=== Genesis AI · Animator — Initializing Environment ==="
...
function provisioning_start() {
    ...
    echo "##############################################"
    echo "#                                            #"
    echo "#        GENESIS AI · ANIMATOR 2.0           #"
    echo "#        Professional Animation Pipeline     #"
    echo "#                                            #"
    echo "##############################################"
    echo ""
    ...
    echo ""
    echo "Genesis AI · Environment ready → Starting ComfyUI..."
    echo ""
}
...
echo "=== Genesis AI · Starting ComfyUI ==="
cd "${COMFYUI_DIR}"
